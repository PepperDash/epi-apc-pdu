...
namespace PepperDash.Essentials.Apc.Communications
{
    /// <summary>
    /// 
    /// </summary>
    public class ApcSshClient : Device, ISocketStatusWithStreamDebugging, IAutoReconnect
    {
        ...
        /// Typical constructor.
        /// </summary>
        public ApcSshClient(string key, string hostname, int port, string username, string password) :
            base(key)
        {
    ...
    public class SshConnectionChangeEventArgs : EventArgs
    {
        ...
        /// The client
        /// </summary>
		public ApcSshClient Client { get; private set; }
		...
		public SshConnectionChangeEventArgs(bool isConnected, ApcSshClient client)
        {
